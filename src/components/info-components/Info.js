...
const Info = () => {
    ...
    return (
        ...
        <div className="info-content-container">
            ...
            <p>The slash fee is in place to give holders a peace of mind that not only panic sellers and ruggers have a less 20% impact on 
            the market, but also having that slash fee rewarded back to them!</p>

            <h3>Locked Vault</h3>
            <p>$PURU can be staked into the locked vault between 30 to 100 days (only whole days are acceptable such as 31 or 84 days, not 34.5 days).
            ...
            <p>In plain terms, users who choose a longer staking period gains a much higher rating compared to shorter staking periods, while a 
            100-day cap is also added so that short-term stakers can get a fair share of the rewards pool as well.</p>
            <br></br>
